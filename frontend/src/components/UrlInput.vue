  ...
  <div class="px-4 mb-6">
    <div class="gradient-border glow-input transition-shadow duration-300">
      <div class="flex items-center gap-2 bg-bg-tertiary rounded-2xl px-4 py-3">
        <!-- Link icon -->
        <svg class="w-5 h-5 text-text-tertiary flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <button v-if="modelValue" @click="$emit('clear')"
                class="text-text-tertiary hover:text-text-secondary transition-colors p-1">
